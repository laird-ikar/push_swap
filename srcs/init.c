...
/*   Updated: 2023/08/10 14:28:04 by bguyot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_pushswap	init(void)
{
	...
	ret.stack_a = ft_calloc(1, sizeof(t_list *));
	ret.stack_b = ft_calloc(1, sizeof (t_list *));
	ret.operations = ft_calloc(1, sizeof(t_list *));
	return (ret);
}
